...
#include <stddef.h>
#include "test_action/action/detail/test__rosidl_typesupport_introspection_c.h"
#include "test_action/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  test_action__action__Test_Goal__init(message_memory);
}

void Test_Goal__rosidl_typesupport_introspection_c__Test_Goal_fini_function(void * message_memory)
{
  test_action__action__Test_Goal__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Test_Goal__rosidl_typesupport_introspection_c__Test_Goal_message_member_array[1] = {
  {
    ...
    offsetof(test_action__action__Test_Goal, pose),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Test_Goal__rosidl_typesupport_introspection_c__Test_Goal_message_members = {
  "test_action__action",  // message namespace
  "Test_Goal",  // message name
  1,  // number of fields
  sizeof(test_action__action__Test_Goal),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_test_action
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_action, action, Test_Goal)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  test_action__action__Test_Result__init(message_memory);
}

void Test_Result__rosidl_typesupport_introspection_c__Test_Result_fini_function(void * message_memory)
{
  test_action__action__Test_Result__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Test_Result__rosidl_typesupport_introspection_c__Test_Result_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_action__action__Test_Result, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Test_Result__rosidl_typesupport_introspection_c__Test_Result_message_members = {
  ...
  1,  // number of fields
  sizeof(test_action__action__Test_Result),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_test_action
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_action, action, Test_Result)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  test_action__action__Test_Feedback__init(message_memory);
}

void Test_Feedback__rosidl_typesupport_introspection_c__Test_Feedback_fini_function(void * message_memory)
{
  test_action__action__Test_Feedback__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Test_Feedback__rosidl_typesupport_introspection_c__Test_Feedback_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_action__action__Test_Feedback, feedback),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Test_Feedback__rosidl_typesupport_introspection_c__Test_Feedback_message_members = {
  ...
  1,  // number of fields
  sizeof(test_action__action__Test_Feedback),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_test_action
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_action, action, Test_Feedback)() {
...
// Member `goal`
#include "test_action/action/test.h"
// Member `goal`
// already included above
// #include "test_action/action/detail/test__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  test_action__action__Test_SendGoal_Request__init(message_memory);
}

void Test_SendGoal_Request__rosidl_typesupport_introspection_c__Test_SendGoal_Request_fini_function(void * message_memory)
{
  test_action__action__Test_SendGoal_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Test_SendGoal_Request__rosidl_typesupport_introspection_c__Test_SendGoal_Request_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_action__action__Test_SendGoal_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_action__action__Test_SendGoal_Request, goal),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Test_SendGoal_Request__rosidl_typesupport_introspection_c__Test_SendGoal_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(test_action__action__Test_SendGoal_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_test_action
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_action, action, Test_SendGoal_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  test_action__action__Test_SendGoal_Response__init(message_memory);
}
...
{
  test_action__action__Test_SendGoal_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Test_SendGoal_Response__rosidl_typesupport_introspection_c__Test_SendGoal_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_action__action__Test_SendGoal_Response, accepted),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_action__action__Test_SendGoal_Response, stamp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Test_SendGoal_Response__rosidl_typesupport_introspection_c__Test_SendGoal_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(test_action__action__Test_SendGoal_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_test_action
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_action, action, Test_SendGoal_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_SendGoal_service_members = {
  "test_action__action",  // service namespace
  "Test_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_SendGoal_service_type_support_handle = {
  0,
  &test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_action, action, Test_SendGoal)() {
  if (!test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_SendGoal_service_type_support_handle.typesupport_identifier) {
    test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_SendGoal_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_action, action, Test_SendGoal_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_action, action, Test_SendGoal_Response)()->data;
  }

  return &test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_SendGoal_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  test_action__action__Test_GetResult_Request__init(message_memory);
}
...
{
  test_action__action__Test_GetResult_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Test_GetResult_Request__rosidl_typesupport_introspection_c__Test_GetResult_Request_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_action__action__Test_GetResult_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Test_GetResult_Request__rosidl_typesupport_introspection_c__Test_GetResult_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(test_action__action__Test_GetResult_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_test_action
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_action, action, Test_GetResult_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  test_action__action__Test_GetResult_Response__init(message_memory);
}
...
{
  test_action__action__Test_GetResult_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Test_GetResult_Response__rosidl_typesupport_introspection_c__Test_GetResult_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_action__action__Test_GetResult_Response, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_action__action__Test_GetResult_Response, result),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Test_GetResult_Response__rosidl_typesupport_introspection_c__Test_GetResult_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(test_action__action__Test_GetResult_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_test_action
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_action, action, Test_GetResult_Response)() {
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_GetResult_service_members = {
  "test_action__action",  // service namespace
  "Test_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_GetResult_service_type_support_handle = {
  0,
  &test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_test_action
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_action, action, Test_GetResult)() {
  if (!test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_GetResult_service_type_support_handle.typesupport_identifier) {
    test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_GetResult_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_action, action, Test_GetResult_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_action, action, Test_GetResult_Response)()->data;
  }

  return &test_action__action__detail__test__rosidl_typesupport_introspection_c__Test_GetResult_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  test_action__action__Test_FeedbackMessage__init(message_memory);
}

void Test_FeedbackMessage__rosidl_typesupport_introspection_c__Test_FeedbackMessage_fini_function(void * message_memory)
{
  test_action__action__Test_FeedbackMessage__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Test_FeedbackMessage__rosidl_typesupport_introspection_c__Test_FeedbackMessage_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_action__action__Test_FeedbackMessage, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_action__action__Test_FeedbackMessage, feedback),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Test_FeedbackMessage__rosidl_typesupport_introspection_c__Test_FeedbackMessage_message_members = {
  ...
  2,  // number of fields
  sizeof(test_action__action__Test_FeedbackMessage),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_test_action
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_action, action, Test_FeedbackMessage)() {
